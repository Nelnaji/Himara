          ...
          <div class="row">
            <div class="col-lg-7 col-12">
              <div data-slider-id="services" class="services-owl owl-carousel">
                ...
                <figure class="gradient-overlay">
                  <img
                    src="images/services/conference.jpg"
                    class="img-fluid"
                    alt="Image"
                  />
                  <figcaption>
                ...
                <figure class="gradient-overlay">
                  <img
                    src="images/services/swimming.jpg"
                    class="img-fluid"
                    alt="Image"
                  />
                  <figcaption>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-8 col-12">
                    <div class="info">
                      ...
                      <p>
                        Lorem ipsum dolor sit amet, elit, sed diam nonummy nibh
              ...
              <div class="restaurant-menu-item">
                <div class="row">
                  <div class="col-lg-4 col-12">
                    <figure>
                      <img
                        src="images/restaurant/restaurant2.jpg"
                        class="img-fluid"
                        alt="Image"
                      />
                    </figure>
