      ...
      <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        <div class="flex-1 px-3 bg-white divide-y space-y-1">
          <ul class="space-y-2 pb-2">
            ...
            <li>
              <a href="{{ "/" | relURL }}" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
            ...
            <li>
              <a href="https://demo.themesberg.com/windster-pro/kanban/" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group {{ if eq $page_slug "inbox" }} bg-gray-100 {{ end }}">
            ...
            <li>
              <a href="https://demo.themesberg.com/windster-pro/mailing/inbox/" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group {{ if eq $page_slug "inbox" }} bg-gray-100 {{ end }}">
            ...
            <li>
              <a href="{{ "users/list/" | relURL }}" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group {{ if eq $page_slug "inbox" }} bg-gray-100 {{ end }}">
            ...
            <li>
              <a href="{{ "e-commerce/products/" | relURL }}" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group {{ if eq $page_slug "inbox" }} bg-gray-100 {{ end }}">
            ...
            <li>
              <a href="{{ "authentication/sign-in/" | relURL }}" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group {{ if eq $page_slug "inbox" }} bg-gray-100 {{ end }}">
            ...
            <li>
              <a href="{{ "authentication/sign-up/" | relURL }}" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group {{ if eq $page_slug "inbox" }} bg-gray-100 {{ end }}">
          ...
          <div class="space-y-2 pt-2">
            <a href="{{ "/pricing/" | relURL }}" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
