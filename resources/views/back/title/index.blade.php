                  ...
                  <tbody>
                    ...
                    >
                      <a
                        ...
                        onclick="openDropdown(event,'table-light-{{ $title->id }}-dropdown')"
                      >
                      ...
                      <div
                        ...
                        id="table-light-{{ $title->id }}-dropdown"
                      >
                        <a
                          href="{{ route('title.edit', $title->id) }}"
...
<form method="POST" action="{{ route('title.destroy', $title) }}">
@method('DELETE')
  @csrf
