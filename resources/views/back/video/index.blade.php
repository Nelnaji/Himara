                    ...
                    <tr>
                      ...
                      >
                        <a
                          ...
                          onclick="openDropdown(event,'table-light-{{ $video->id }}-dropdown')"
                        >
                        ...
                        <div
                          ...
                          id="table-light-{{ $video->id }}-dropdown"
                        >
                          <a
                          ...
                          ></div>
                          <a
                            href="{{ route('video.destroy', $video) }}"
                            class="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-blueGray-700"
                            >Delete</a
                          >
                        </div>
