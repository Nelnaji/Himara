                    ...
                    <tr>
                      ...
                      >
                        <a
                          ...
                          onclick="openDropdown(event,'table-light-{{ $restaurant->id }}-dropdown')"
                        >
                        ...
                        <div
                          ...
                          id="table-light-{{ $restaurant->id }}-dropdown"
                        >
                          <a
                            href="{{ route('restaurant.edit', $restaurant->id) }}"
                          ...
                          ></div>
                          <a
                            href="{{ route('restaurant.destroy', $restaurant) }}"
                            class="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-blueGray-700"
                            >Delete</a
                          >
                        </div>
